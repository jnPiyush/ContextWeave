# Technical Specification: ContextWeave System
...
**Date**: 2026-01-29  
**Related ADR**: [ADR-CONTEXT-WEAVE.md](../adr/ADR-CONTEXT-WEAVE.md)  
**Related PRD**: [PRD-CONTEXT-WEAVE.md](../prd/PRD-CONTEXT-WEAVE.md)
...
ContextWeave is a runtime context management and quality orchestration system that enables AI agents to achieve >95% success rate in production-ready code generation.
...
```
.context-weave/                     # Runtime state directory
...
**File**: `.context-weave/context-{issue}.md`
...
**File**: `.context-weave/subagent-status.json`
...
**File**: `.context-weave/audit-log.json`
...
**File**: `.context-weave/local-issues.json`
...
**File**: `.context-weave/metrics-{date}.json`
...
**File**: `.context-weave/certificates/cert-{issue}.json`
...
11. Write to .context-weave/context-{issue}.md
...
3. Read .context-weave/local-issues.json
...
| File Operations | `read_file`, `create_file` | Access .context-weave/ |
...
│  │  ✓ .context-weave/plan-456.md                                          │ │
│  │  ✓ docs/prd/PRD-{ref}.md (if in References)                            │ │
│  │  ✓ docs/adr/ADR-{ref}.md (if in References)                            │ │
│  │  ✓ src/auth/*.ts (if in References)                                    │ │
│  │                                                                         │ │
│  │  BLOCKED:                                                               │ │
│  │  ✗ .context-weave/context-457.md (other SubAgent)                      │ │
│  │  ✗ .context-weave/context-458.md (other SubAgent)                      │ │
...
- [ ] Create `.context-weave/` directory structure
