...
Usage:
    context-weave issue create <title>
    context-weave issue list
    context-weave issue show <issue>
    context-weave issue close <issue>
"""
...
def issue_cmd() -> None:
    ...
    In 'github' mode, use 'context-weave sync issues' to view GitHub issues.

    \b
    Examples:
        context-weave issue create "Add user authentication"
        context-weave issue list
        context-weave issue show 1
        context-weave issue close 1
    """
...
def create_cmd(ctx: click.Context, title: str, body: Optional[str],
    ...
    \b
    Examples:
        context-weave issue create "Add login page"
        context-weave issue create "Fix bug" --type bug --label priority:p0
        context-weave issue create "Design auth flow" --type feature --role architect
    """
    ...
    click.echo("")
    click.echo(f"Next: context-weave subagent spawn {issue_number} --role {role or 'engineer'}")
