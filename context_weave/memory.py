...
class Memory:
    ...
    Memory is stored in .context-weave/memory.json and includes:
    ...
    def __init__(self, repo_root: Path):
        ...
        self.memory_dir = repo_root / ".context-weave"
    ...
    def _default_memory(self) -> Dict[str, Any]:
        ...
        return {
            "$schema": "https://contextweave.dev/schemas/memory-v1.json",
            "version": "1.0",
            "lessons": [],
            "executions": [],
