...
Injects Context.md's 4-layer context architecture into every
...
class ContextMdProvider:
    """Injects Context.md's 4-layer context into Agent Framework agents.
    ...
    async def __aenter__(self) -> "ContextMdProvider":
        return self
    ...
    def _build_system_instructions(self) -> str:
        ...
        try:
            from context_md.commands.context import load_role_instructions
        ...
        try:
            from context_md.commands.context import load_skills
