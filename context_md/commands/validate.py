...
def _run_dod_check(repo_root: Path, issue: int, role: str, check_id: str, state: State) -> Tuple[bool, str]:
...
def _generate_certificate(repo_root: Path, issue: int, role: str, results: List) -> None:
    ...
    click.echo("")
    click.secho(f"✅ Certificate generated: {cert_path}", fg="green")
